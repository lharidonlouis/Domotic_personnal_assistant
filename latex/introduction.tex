...
\begin{itemize}
\item Capable de disposer des objets dans un environnement simulé.
\item Système de messagerie pour permettre une conversation entre l'assistant de la maison et l'utilisateur.
\item Automatisation de tâches issues de la routine de l'utilisateur.
\item Affichage de l'état d'un objet (allumé, éteint ou défaillant).
\end{itemize}
...
L'équipe est composée de trois personnes, Louis L'Haridon, étudiant de L2 CMI SIC, Julien Demoineret et Valentin Petiteville, étudiants en L2 Informatique à l'université de Cergy-Pontoise